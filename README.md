...
> Answer: In a word: speed. It allows one to build fast single-page applications, because everything (or as much as possible) is loaded along with the original network request and stored for later.
